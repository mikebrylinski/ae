...
interface PhotoHeaderProps {
  src: string
  alt: string
  /** Accessible name for the header. Also the default card title when `children` is omitted. */
  heading: string
  subheading?: string
  /** Replaces the default centered title card (e.g. a section header over the photo). */
  children?: ReactNode
}
