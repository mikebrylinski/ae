...
interface ConsolePanelProps {
  className?: string
  /** Overall panel opacity — can be solid since it no longer fights text. */
  opacity?: number
}
...
/**
 * In-flow mixing-console panel for the hero right column.
 * Vertical faders ride independently; static under prefers-reduced-motion.
 */
export function ConsolePanel({ className, opacity = 0.82 }: ConsolePanelProps) {
