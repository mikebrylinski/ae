...
const en = {
  ...
  portfolio: {
    ...
    heroAlt: 'Andy in Times Square with in-ear monitors',
  ...
  galleryPage: {
    ...
    photo: 'Photo',
    loading: 'Loading',
    missingTitle: 'Photo not found',
    missing: 'This photo is not in the live gallery.',
    seoPhotoDescription: '{caption} — photo from Andy Ebert’s tour gallery.',
    altLabel: 'Description',
    tagsLabel: 'Tags',
    categoryLabel: 'Scene',
    photoFrom: 'from AndyEbert.com',
...
const de = {
  ...
  a11y: {
    ...
    creditsList: 'Karriere-Referenzen',
    pressList: 'Presseberichte',
    filterCredits: 'Referenzen nach Rolle filtern',
    filterCategory: 'Nach Kategorie filtern',
    filterPress: 'Presse nach Typ filtern',
    filterGallery: 'Galerie nach Schlagworten filtern',
    toggleFilters: 'Filter ein- oder ausblenden',
    sortGallery: 'Galerie sortieren',
    creditsPageTop: 'Referenzen-Seiten oben',
    creditsPageBottom: 'Referenzen-Seiten unten',
  ...
  portfolio: {
    seoTitle: 'Portfolio',
    seoDescription:
      'Ausgewählte Karriere-Referenzen des Monitor Engineers Andy Ebert — Arena, Stadion, Amphitheater, Festival, TV und Corporate, von 1997 bis heute.',
    ...
    heroAlt: 'Andy am Times Square mit In-Ear-Monitoren',
    headerAlt: 'Mischpult und Arena aus der Monitor World',
  },
  credits: {
    eyebrow: 'Zeitachse',
    title: 'Karriere-Referenzen',
  ...
  galleryPage: {
    ...
    newest: 'Neueste',
    oldest: 'Älteste',
    tagAz: 'Schlagwort A–Z',
    sceneLabel: 'Schlagworte',
    ...
    photo: 'Foto',
    loading: 'Laden',
    missingTitle: 'Foto nicht gefunden',
    missing: 'Dieses Foto ist nicht in der Live-Galerie.',
    seoPhotoDescription: '{caption} — Foto aus Andy Eberts Tour-Galerie.',
    altLabel: 'Beschreibung',
    tagsLabel: 'Schlagworte',
    categoryLabel: 'Szene',
    photoFrom: 'von AndyEbert.com',
  ...
  filters: {
    ...
    'Musical Direction': 'Musikalische Leitung',
    Backstage: 'Backstage',
    'Monitor World': 'Monitor World',
    Rehearsals: 'Proben',
    Crew: 'Crew',
